...
namespace Klove_Crud.Models
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Department,departmentManager")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Department,departmentManager")] Departments departments)
        {
            if (ModelState.IsValid)
            {
